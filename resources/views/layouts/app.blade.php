...
<head>
    ...
    <title>@yield('title', 'PocketFlow')</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('css/dashboard.css') }}">
    <link rel="stylesheet" href="{{ asset('css/goal.css') }}">
    <link rel="stylesheet" href="{{ asset('css/profile.css') }}">
    <link rel="stylesheet" href="{{ asset('css/pemasukan.css') }}">
    <link rel="stylesheet" href="{{ asset('css/navbar.css') }}">
</head>

<body>
    <!-- Navbar untuk Mode Mobile -->
    <nav class="navbar navbar-dark bg-dark d-md-none">
        <div class="container-fluid">
            ...
            <span class="navbar-brand mb-0 h1">PocketFlow</span>
        </div>
    </nav>
    ...
    <div class="collapse d-md-block" id="sidebarMenu">
        <div class="sidebar">
            <div class="sidebar-logo">
                <img src="{{ asset('images/layout_images/pocketFlowLogo.svg') }}" alt="PocketFlow Logo" width="150"
                    height="100">
            ...
            <a href="{{ route('pemasukan.index') }}"
                class="{{ request()->routeIs('pemasukan.index') ? 'active' : '' }}">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke-linejoin="round" />
                    <path d="M4 6V18C4 19.1 4.9 20 6 20H20V16" stroke="white" stroke-opacity="0.7" stroke-width="2"
            ...
            <a href="{{ route('pengeluaran.index') }}"
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M17 11L21 7L17 3" stroke="white" stroke-opacity="0.7" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M21 7H9" stroke="white" stroke-opacity="0.7" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M7 21L3 17L7 13" stroke="white" stroke-opacity="0.7" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M15 17H3" stroke="white" stroke-opacity="0.7" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
            ...
            <a href="{{ route('goals.index') }}" class="{{ request()->routeIs('goals.index') ? 'active' : '' }}">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="white" stroke-opacity="0.7" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M22 12H18" stroke="white" stroke-opacity="0.7" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M6 12H2" stroke="white" stroke-opacity="0.7" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M12 6V2" stroke="white" stroke-opacity="0.7" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M12 22V18" stroke="white" stroke-opacity="0.7" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
            ...
            <div class="logout-container">
                <form action="{{ route('logout') }}" method="POST" style="display: inline;">
                    @csrf
                    <button type="submit" class="logout d-flex align-items-center justify-content-center">
                        <img src="{{ asset('images/layout_images/logout.svg') }}" alt="Logout Icon"
            ...
            <div class="sidebar-footer">
                <div class="sidebar-profile">
                    <img src="{{ $loggedInUser->profile_picture ? asset('storage/' . $loggedInUser->profile_picture) : asset('profile_pictures/default-profile.png') }}"
                        alt="Profile Picture">
                    <div>
                        <span>{{ $loggedInUser->name }}</span><br>
